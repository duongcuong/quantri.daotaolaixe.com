        ...
        <div class="">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tạo xe mới</li>
                </ol>
            </nav>
        </div>
    </div>
...
<form action="{{ route('admins.vehicles.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="gptl_number" id="gptl_number" class="form-control" value="{{ old('gptl_number') }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="gptl_expiry_date">Ngày hết hạn GPTL</label>
                            <input type="date" name="gptl_expiry_date" id="gptl_expiry_date" class="form-control" value="{{ old('gptl_expiry_date') }}">
                        </div>
                        <div class="form-group col-md-4">
