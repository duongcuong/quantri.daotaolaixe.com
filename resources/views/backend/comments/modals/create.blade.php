<!-- Modal add -->
<div class="modal fade" id="modal-comments-create-ajax" aria-labelledby="modal-comments-create-ajaxLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <form class="row g-3 needs-validation form-submit-ajax" method="POST" action="{{ route('admins.comments.store') }}" data-reload="#load-data-ajax-comments">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-comments-create-ajaxLabel">Thêm lịch sử học phí</h5>
