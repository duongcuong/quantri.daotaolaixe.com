<!-- Modal add -->
<div class="modal fade" id="modal-vehicle-expenses-create-ajax"
    aria-labelledby="modal-vehicle-expenses-create-ajaxLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <form class="row g-3 needs-validation form-submit-ajax" method="POST"
            action="{{ route('admins.vehicle-expenses.store') }}" data-reload="#load-data-ajax-vehicle-expenses">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-vehicle-expenses-create-ajaxLabel">Thêm chi phí</h5>
