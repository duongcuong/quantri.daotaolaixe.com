<!-- Modal add -->
<div class="modal fade" id="modal-calendars-tot-nghiep-create-ajax" aria-labelledby="modal-calendars-tot-nghiep-create-ajaxLabel"
        ...
        <form class="row g-3 needs-validation form-submit-ajax" method="POST"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-calendars-tot-nghiep-create-ajaxLabel">Thêm {!!
