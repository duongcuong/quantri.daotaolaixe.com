        ...
        <div class="">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lịch thi tốt nghiệp ngày {{ getDateTimeStamp(request()->date_start, 'd/m/Y') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="card radius-15">
    <div class="card-body">
        <form data-reload="#load-data-ajax-exam-tot-nghiep-calendars" id="search-form-class-calendars"
            ...
            <input type="hidden" name="reload" value="load-data-ajax-exam-tot-nghiep-calendars">
            <div class="row">
...
<div class="card radius-15">
    <div class="card-body">
        <div id="load-data-ajax-exam-tot-nghiep-calendars" class="table-header-fixed mt-1 mb-1 load-data-ajax"
