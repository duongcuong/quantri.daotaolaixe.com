<!-- Modal edit -->
<div class="modal fade" id="modal-calendars-sat-hach-edit-ajax" tabindex="-1" aria-labelledby="modal-calendars-sat-hach-edit-ajaxLabel"
        ...
        <form class="row g-3 needs-validation form-submit-ajax" method="POST"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-calendars-sat-hach-edit-ajaxLabel">Chỉnh sửa lịch</h5>
