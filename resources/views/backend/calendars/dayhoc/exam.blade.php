...
<div class="d-flex mb-3">
    ...
    <div class="ml-auto">
        ...
        <a class="btn btn-outline-primary btn-sm btn-create-ajax"
            href="{{ route('admins.calendars.create', ['type' => 'class_schedule', 'date_start' => request()->date_start, 'reload' => 'load-data-ajax-exam-day-hoc-calendars']) }}"
            data-cs-modal="#modal-calendars-day-hoc-create-ajax" title="Thêm mới"><i class="bx bx-plus"></i>Thêm học viên</a>
        {{-- @endif --}}
...
<div class="card radius-15">
    <div class="card-body">
        <form data-reload="#load-data-ajax-exam-day-hoc-calendars" id="search-form-class-calendars"
...
<div class="card radius-15">
    <div class="card-body">
        <div id="load-data-ajax-exam-day-hoc-calendars" class="table-header-fixed mt-1 mb-1 load-data-ajax"
