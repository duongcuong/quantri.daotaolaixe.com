        ...
        <div class="">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lịch thi hết môn lý thuyết ngày {{ getDateTimeStamp(request()->date_start, 'd/m/Y')}}</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="ml-auto">
        <a class="btn btn-outline-danger btn-sm mr-2 reset-search-action" href="{{ route('admins.calendars.lt-date') }}"
...
<div class="card radius-15">
    <div class="card-body">
        <form data-reload="#load-data-ajax-exam-ly-thuyet-calendars" id="search-form-class-calendars"
            ...
            <input type="hidden" name="reload" value="load-data-ajax-exam-ly-thuyet-calendars">
            <div class="row">
...
<div class="card radius-15">
    <div class="card-body">
        <div id="load-data-ajax-exam-ly-thuyet-calendars" class="table-header-fixed mt-1 mb-1 load-data-ajax"
