...
<div class="d-flex mb-3">
    ...
    <div class="ml-auto">
        ...
        <a class="btn btn-outline-primary btn-sm btn-create-ajax"
            href="{{ route('admins.calendars.create', ['type' => 'lythuyet', 'reload' => 'load-data-ajax-exam-date-calendars']) }}"
            data-cs-modal="#modal-calendars-ly-thuyet-create-ajax" title="Tạo Lịch Thi"><i class="bx bx-plus"></i>Tạo Lịch Thi</a>
        @endif
    </div>
</div>
