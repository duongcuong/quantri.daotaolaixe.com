...
<div class="d-flex mb-3">
        ...
        <div class="">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lịch thi hết môn thực hành</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="ml-auto">
        ...
        <a class="btn btn-outline-primary btn-sm btn-create-ajax"
            href="{{ route('admins.calendars.create', ['type' => 'thuchanh', 'reload' => 'load-data-ajax-exam-date-calendars']) }}"
            data-cs-modal="#modal-calendars-thuc-hanh-create-ajax" title="Tạo Lịch Thi"><i class="bx bx-plus"></i>Tạo Lịch Thi</a>
        @endif
    </div>
</div>
...
<div class="card radius-15">
    <div class="card-body">
        <form data-reload="#load-data-ajax-exam-date-calendars" id="search-form-class-calendars"
            ...
            <input type="hidden" name="group_by" value="date_thuchanh">
            <div class="row">
