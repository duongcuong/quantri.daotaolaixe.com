...
<div class="d-flex mb-3">
    ...
    <div class="ml-auto">
        ...
        <a class="btn btn-outline-primary btn-sm btn-create-ajax"
            href="{{ route('admins.calendars.create', ['type' => 'student_class_schedule', 'date_start' => request()->date_start, 'reload' => 'load-data-ajax-exam-lich-hoc-calendars']) }}"
            data-cs-modal="#modal-calendars-lich-hoc-create-ajax" title="Thêm mới"><i class="bx bx-plus"></i>Thêm học viên</a>
        {{-- @endif --}}
...
<div class="card radius-15">
    <div class="card-body">
        <form data-reload="#load-data-ajax-exam-lich-hoc-calendars" id="search-form-class-calendars"
