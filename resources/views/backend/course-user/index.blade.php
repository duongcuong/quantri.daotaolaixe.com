...
<div class="d-flex mb-3">
    ...
    <div class="ml-auto">
        ...
        <a class="btn btn-outline-primary btn-sm" href="{{ route('admins.course-user.create') }}" title="Thêm học viên vào khoá học"><i
                class="bx bx-plus"></i>Thêm học viên vào khoá học</a>
        @endif
    </div>
</div>
