        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="load-data-ajax-calendars" class="table-responsive mt-1 mb-1 load-data-ajax" data-search="#search-form-calendars" data-url="{{ route('admins.calendars.data', ['course_user_id' => $courseUser->id, 'type' => 'exam_schedule', 'show_column' => 'name,priority,status,date_start,date_end,loai_thi,tuition_fee,ngay_dong_hoc_phi']) }}">
