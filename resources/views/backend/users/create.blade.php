        ...
        <div class="">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tạo học viên mới</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="gender" id="gender" class="form-control" required>
                                ...
                                <option value="{{ $key }}" {{ old('gender', 0)== $key ? 'selected' : '' }}>{{ $item }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="identity_card" id="identity_card" class="form-control" value="{{ old('identity_card') }}">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        {{-- <div class="form-group col-md-6">
                            ...
                            <input type="text" name="card_name" id="card_name" class="form-control" value="{{ old('card_name') }}">
                        </div> --}}
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="status" id="status" class="form-control" required>
                                ...
                                <option value="{{ $key }}" {{ old('status', 1)== $key ? 'selected' : '' }}>{{ $item }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
