                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="select2-ajax-single form-control" name="user_id" data-selected-id="{{ $lead->user_id }}" data-placeholder="Chọn học viên" data-url="{{ route('admins.users.list') }}" id="change-hoc-vien" data-limit="{{ LIMIT }}">
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="select2-ajax-single form-control" name="assigned_to" data-selected-id="{{ $lead->assigned_to }}" data-placeholder="Chọn người phụ trách" data-url="{{ route('admins.admins.list', ['role'=> ROLE_SALE]) }}" data-limit="{{ LIMIT }}">
                            </select>
                        </div>
                        <div class="form-group col-md-6">
