...
<form class="row g-3 needs-validation form-submit-ajax-convert-lead" method="POST"
    action="{{ route('admins.leads.convert_list') }}">
    @csrf
                            ...
                            <div class="card radius-15">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control select-option-type-user-lead"
                                            name="select_lead_user_type">
                                    ...
                                    <div class="box-lead-not-user" style="display: none">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="users[address]" id="address"
                                                    class="form-control" value="{{ old('address', $lead->address) }}">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="dob">Ngày sinh</label>
                                                <input type="date" name="users[dob]" id="dob" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="card radius-15">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control select-option-type-course-lead"
                                            name="select_lead_course_type">
                                            <option value="">Vui lòng chọn</option>
                                    ...
                                    <div class="box-lead-not-course" style="display: none">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="courses[code]" id="code" class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="rank" class="form-label">Hạng</label>
                                                <select name="courses[rank]" id="rank"
                                                    class="form-control single-select">
                                                    @foreach (listRanks() as $key => $value)
                                                    <option value="{{ $key }}" {{ $key==old('rank') ? 'selected' : ''
                                                        }}>{{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="courses[rank_gp]" id="rank_gp"
                                                    class="form-control single-select">
                                                    @foreach (listRanks() as $key => $value)
                                                    <option value="{{ $key }}" {{ $key==old('rank_gp') ? 'selected' : ''
                                                        }}>{{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="courses[number_bc]" id="number_bc"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="date_bci" class="form-label">Ngày BCI</label>
                                                <input type="date" name="courses[date_bci]" id="date_bci"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="start_date" class="form-label">Ngày bắt đầu</label>
                                                <input type="date" name="courses[start_date]" id="start_date"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="end_date" class="form-label">Ngày kết thúc</label>
                                                <input type="date" name="courses[end_date]" id="end_date"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="tuition_fee" class="form-label">Học phí</label>
                                                <input type="number" name="courses[tuition_fee]" id="tuition_fee"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="number_students" class="form-label">Số học viên</label>
                                                <input type="number" name="courses[number_students]"
                                                    id="number_students" class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="decision_kg" class="form-label">Quyết định KG</label>
                                                <input type="text" name="courses[decision_kg]" id="decision_kg"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="duration" class="form-label">Thời gian</label>
                                                <input type="number" name="courses[duration]" id="duration"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
