...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 21, 2023 lúc 05:12 AM
...
INSERT INTO `pigs` (`id`, `code`, `origin`, `gender`, `type`, `breed_id`, `status`, `birthday`, `father_id`, `mother_id`, `pig_breed_id`, `created_at`, `updated_at`) VALUES
(26, 'ABCCDA', 'ttgvn', 'female', 'reserve', 8, 'normal', '2023-12-13 17:00:00', 29, 28, 48, '2023-12-14 07:28:06', '2023-12-15 03:48:45'),
(27, 'ABCCDAE', 'ttgvn', 'female', 'reserve', 7, 'normal', '2023-12-12 17:00:00', 26, NULL, 48, '2023-12-14 07:39:06', '2023-12-14 07:39:06'),
(28, 'ABCCDAD', 'ttgvn', 'male', 'manufacture', 8, NULL, '2023-12-12 17:00:00', 27, NULL, 48, '2023-12-14 07:49:25', '2023-12-14 07:49:25'),
(31, 'sabccD', 'ttgvn', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-15 10:48:46', '2023-12-19 06:30:46'),
(45, 'ABCCDAAA', 'ttgvn', 'male', NULL, 7, NULL, NULL, NULL, NULL, NULL, '2023-12-19 08:19:56', '2023-12-19 08:19:56'),
(46, 'ABCCDAMM', 'ttgvn', 'male', NULL, 7, NULL, NULL, NULL, NULL, NULL, '2023-12-19 08:23:10', '2023-12-19 08:23:10'),
(47, 'ABCCDAEMMM', 'ttgvn', 'male', NULL, 7, NULL, NULL, NULL, NULL, 48, '2023-12-19 08:24:40', '2023-12-19 08:24:40'),
(48, 'AMCMM', 'ttgvn', 'male', NULL, 7, NULL, NULL, NULL, NULL, 48, '2023-12-19 08:29:11', '2023-12-19 08:29:11'),
(49, 'abcMM', 'ttgvn', 'male', NULL, 7, NULL, NULL, NULL, NULL, 48, '2023-12-19 08:30:24', '2023-12-19 08:30:24'),
(50, 'BBBBB', 'ttgvn', 'male', 'reserve', 7, 'normal', '2023-12-17 17:00:00', NULL, NULL, 48, '2023-12-19 08:33:15', '2023-12-19 08:42:35'),
(51, 'RRRRR', NULL, 'male', 'reserve', NULL, NULL, '2023-12-04 17:00:00', NULL, NULL, 49, '2023-12-19 09:19:03', '2023-12-19 09:19:03'),
(61, 'ABCDEFR', NULL, 'male', 'reserve', NULL, NULL, '2023-12-04 17:00:00', NULL, NULL, 49, '2023-12-19 09:24:57', '2023-12-19 09:24:57'),
(70, 'KKKK', 'ttgvn', 'male', 'reserve', 7, 'normal', '2023-12-03 17:00:00', NULL, NULL, 50, '2023-12-19 10:46:25', '2023-12-19 10:46:25'),
(71, 'ABCCDAK', 'ttgvn', 'female', 'reserve', 7, 'normal', '2023-12-03 17:00:00', NULL, NULL, 50, '2023-12-19 10:46:43', '2023-12-19 10:46:43');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `pig_breeds`
--

DROP TABLE IF EXISTS `pig_breeds`;
...
--
-- Đang đổ dữ liệu cho bảng `pig_breeds`
--

INSERT INTO `pig_breeds` (`id`, `code`, `origin`, `breed_id`, `status`, `birthday`, `weaning_date`, `total`, `total_meat`, `father_id`, `mother_id`, `pig_breed_id`, `created_at`, `updated_at`) VALUES
(38, 'ABCCDA', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, '2023-12-18 09:12:47', '2023-12-18 09:12:47'),
(40, 'ABCCDAMM', 'ttgvn', 8, 'normal', '2023-12-18 17:00:00', NULL, 0, 0, 28, 28, NULL, '2023-12-18 09:15:18', '2023-12-18 09:15:18'),
(43, 'MMMMM', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, '2023-12-18 09:18:04', '2023-12-18 09:18:04'),
(44, 'HHHH', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, '2023-12-18 09:18:24', '2023-12-18 09:18:24'),
(47, 'bbbb', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, '2023-12-18 09:20:04', '2023-12-18 09:20:04'),
(48, 'ABCCDAAA', 'ttgvn', 7, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, '2023-12-18 09:22:16', '2023-12-18 09:22:16'),
(49, 'ABCDEF', 'ttgvn', NULL, 'normal', '2023-12-04 17:00:00', '2023-12-11 17:00:00', 34, 2323, 47, 45, NULL, '2023-12-19 09:18:15', '2023-12-20 10:32:33');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `pig_breed_healths`
--

DROP TABLE IF EXISTS `pig_breed_healths`;
CREATE TABLE IF NOT EXISTS `pig_breed_healths` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `setting_disease_id` int(11) NOT NULL,
  `pig_breed_id` int(11) NOT NULL,
  `day_of_illness` timestamp NULL DEFAULT NULL,
  `medicine` varchar(255) DEFAULT NULL,
  `day_of_recovery` timestamp NULL DEFAULT NULL,
  `note` text DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `pig_breed_healths`
--

INSERT INTO `pig_breed_healths` (`id`, `setting_disease_id`, `pig_breed_id`, `day_of_illness`, `medicine`, `day_of_recovery`, `note`, `created_at`, `updated_at`) VALUES
(29, 2, 48, NULL, NULL, NULL, NULL, '2023-12-18 09:22:16', '2023-12-18 09:22:16'),
(30, 1, 48, NULL, NULL, NULL, NULL, '2023-12-18 09:22:16', '2023-12-18 09:22:16'),
(31, 2, 48, NULL, NULL, NULL, NULL, '2023-12-19 08:42:19', '2023-12-19 08:42:19'),
(32, 1, 48, NULL, NULL, NULL, NULL, '2023-12-19 08:42:19', '2023-12-19 08:42:19'),
(54, 2, 49, '2023-12-18 17:00:00', 'Thuốc 1', '2023-12-03 17:00:00', NULL, '2023-12-20 10:32:33', '2023-12-20 10:32:33'),
(55, 2, 49, '2023-12-11 17:00:00', 'Thuốc 1', '2023-12-04 17:00:00', NULL, '2023-12-20 10:32:33', '2023-12-20 10:32:33'),
(56, 1, 49, '2023-12-02 17:00:00', 'dsfsd', '2023-12-12 17:00:00', NULL, '2023-12-20 10:32:33', '2023-12-20 10:32:33');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `pig_breed_vaccines`
--

DROP TABLE IF EXISTS `pig_breed_vaccines`;
CREATE TABLE IF NOT EXISTS `pig_breed_vaccines` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `pig_breed_vaccines`
--

INSERT INTO `pig_breed_vaccines` (`id`, `setting_vaccine_id`, `pig_breed_id`, `date_of_injection`, `next_injection_day`, `note`, `created_at`, `updated_at`) VALUES
(34, 2, 48, NULL, NULL, NULL, '2023-12-18 09:22:16', '2023-12-18 09:22:16'),
(35, 3, 48, NULL, NULL, NULL, '2023-12-18 09:22:16', '2023-12-18 09:22:16'),
(36, 2, 48, NULL, NULL, NULL, '2023-12-19 08:42:19', '2023-12-19 08:42:19'),
(37, 3, 48, NULL, NULL, NULL, '2023-12-19 08:42:19', '2023-12-19 08:42:19'),
(59, 1, 49, '2023-12-12 17:00:00', '2023-12-11 17:00:00', NULL, '2023-12-20 10:32:33', '2023-12-20 10:32:33'),
(60, 1, 49, '2023-12-12 17:00:00', '2023-12-11 17:00:00', NULL, '2023-12-20 10:32:33', '2023-12-20 10:32:33'),
(61, 3, 49, '2023-12-13 17:00:00', '2023-12-05 17:00:00', NULL, '2023-12-20 10:32:33', '2023-12-20 10:32:33');
...
(25, 1, 28, '2023-12-13 17:00:00', '2023-12-11 17:00:00', NULL, '2023-12-15 10:48:02', '2023-12-15 10:48:02'),
(27, 1, 26, '2023-12-14 17:00:00', '2023-12-12 17:00:00', NULL, '2023-12-18 04:24:45', '2023-12-18 04:24:45'),
...
(39, 2, 47, NULL, NULL, NULL, '2023-12-19 08:24:40', '2023-12-19 08:24:40'),
